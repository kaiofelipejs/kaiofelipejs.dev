...
- Padroniza a forma de escrever: o que reforça o tópico anterior e também tira subjetividades na hora do _code review_ evitando comentários como "faltou espaços aqui e ali" 🙄
...
Organiza e separa seus testes de acordo com o cenário/contexto. Para saber quando usar pense que haverá pelo menos 2 cenários (positivo e negativo). No exemplo abaixo existe o cenário de _logado_ e _não logado_.
...
_Obs: Esse `create` é um método do Factory Bot, vamos falar sobre ele já já._
...
Para ficar mais legal ainda você pode criar _named subjects._ Vamos melhorar um pouquinho esse código acima:
